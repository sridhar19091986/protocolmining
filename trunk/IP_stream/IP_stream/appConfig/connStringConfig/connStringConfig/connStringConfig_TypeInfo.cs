...
{
	public class connStringConfig_TypeInfo
	{
		// namespaces indices
		...
		public static TypeInfo[] types = 
		{
			...
			new TypeInfo( binder, _altova_ni, "", _altova_ti_xs_altova_string2, _altova_mif_altova_providerNameType, _altova_mil_altova_providerNameType,  
				new FacetInfo[]
				{
					new FacetInfo (Altova.Xml.XsValidation.facetCheck_string_enumeration, "enumeration", "System.Data.OracleClient", 0 ), 
					new FacetInfo (Altova.Xml.XsValidation.facetCheck_string_enumeration, "enumeration", "System.Data.SqlClient", 0 ), 
				},

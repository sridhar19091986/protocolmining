...
namespace IP_stream
{
    ...
    {
        //导出到EXCEL速度比较快的方法
        private static bool ExportForDataGridview(DataGridView gridView, string fileName, bool isShowExcle)
        {
            //建立Ｅｘｃｅｌ对象 
        ...
        /// </remarks>  
        /// <returns> </returns>   
        private static bool DataGridviewShowToExcel(DataGridView dgv, bool isShowExcle)
        {
            if (dgv.Rows.Count == 0)
                return false;
            //建立Excel对象   
        ...
        private  static void DataGridViewToExcel2(DataGridView dgv)
        {
